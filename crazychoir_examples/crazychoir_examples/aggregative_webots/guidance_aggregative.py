import rclpy
from crazychoir.guidance.aggregative import AggregativeGuidanceCrazyflie
...
def main():
    ...
    opt_settings = {
        ...
        'stepsize':1e-3,            # stepsize for gradient tracking
        #
    ...
    height = 1.0
    guidance = AggregativeGuidanceCrazyflie(optimizer, height, freq_reference, 'pubsub', 'odom', None,  'position', Vector3)
